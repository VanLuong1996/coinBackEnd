...
/* global ion, Handlebars, Bloodhound */
        ...
        handleSound: function () {
            if($('.page-sound').length){
                ion.sound({
                    ...
                    path: BlankonApp.handleBaseURL()+'/vendor/ionsound/sounds/',
                    preload: true
                });
        ...
        handleTypehead: function () {
            if($('.typeahead').length){
                ...
                repos = new Bloodhound({
                    ...
                    prefetch: BlankonApp.handleBaseURL()+'vendor/assets/admin/data/data-typeahead/typeahead-sample.json'
                });
        ...
        handlePanelToolAction: function () {
            ...
            $('[data-action=refresh]').on('click', function(){
                ...
                setInterval(function(){
                    $.getJSON(BlankonApp.handleBaseURL()+'/vendor/assets/admin/data/reload-sample.json', function(json) {
                        $.each(json, function() {
